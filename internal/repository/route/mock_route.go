...
// Source: github.com/project-flotta/osbuild-operator/internal/repository/route (interfaces: Repository)
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *v1.Route) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1, arg2 string) (*v1.Route, error) {
	m.ctrl.T.Helper()
