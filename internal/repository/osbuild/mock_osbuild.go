...
// Source: github.com/project-flotta/osbuild-operator/internal/repository/osbuild (interfaces: Repository)

// Package osbuild is a generated GoMock package.
package osbuild
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *v1alpha1.OSBuild) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Patch(arg0 context.Context, arg1, arg2 *v1alpha1.OSBuild) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) PatchStatus(arg0 context.Context, arg1 *v1alpha1.OSBuild, arg2 *client.Patch) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1, arg2 string) (*v1alpha1.OSBuild, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Read", arg0, arg1, arg2)
	ret0, _ := ret[0].(*v1alpha1.OSBuild)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
